...
only `.codescent` state in the analyzed repository and does not edit analyzed source files.
Safety summary: writes only .codescent state and does not edit analyzed source
files. The runtime no-network model applies to indexing,
